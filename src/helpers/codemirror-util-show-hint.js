...
;(function(mod) {
  ...
  Completion.prototype = {
    ...
    pick: function(data, i) {
      ...
      } else if (this.options.tags == 'snippets') {
        completion = this.options.schemaInfo[data.list[i]]
  ...
  function Widget(completion, data) {
    ...
    var winW =
      window.innerWidth || Math.max(document.body.offsetWidth, document.documentElement.offsetWidth)
    var winH =
      window.innerHeight ||
